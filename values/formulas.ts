...
export const getGET = ({ factor, formula, sex, weight, height, age }: { factor: any, formula: any, sex: any, weight: any, height: any, age: any }) => {
    let f = factor === 'SEDENTARIO' ? faValues.SEDENTARIO : factor === 'LIGERO' ? faValues.LIGERO :
        factor === 'MODERADO' ? faValues.MODERADO : factor === 'ACTIVO' ? faValues.ACTIVO :
            factor === 'VIGOROSO' ? faValues.VIGOROSO : 0
    switch (formula) {
